...
describe("CivicAuthIframeContainer", () => {
    ...
    it(`triggers a fetch request when '${TOKEN_EXCHANGE_TRIGGER_TEXT}' is in the iframe body`, async () => {
        ...
        await waitFor(() => {
            expect(fetchMock).toHaveBeenCalledWith("https://example.com/redirect?code=1234&appUrl=http://localhost:3000");
...
//# sourceMappingURL=CivicAuthIframeContainer.test.js.map